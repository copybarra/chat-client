  ...
  return (
    <div className="profile-bar flex h-full px-4 items-center justify-between text-white border-r-0 border-white">
      ...
      >
        ...
        <input id="pb-search" type="text" className={`flex focus:outline-0 duration-500 items-center bg-[#414163] text-[12px] rounded-lg ${isOpen ? 'w-52' : 'w-0'}`} placeholder="Search..." />
      </div>
    </div>
  );
}